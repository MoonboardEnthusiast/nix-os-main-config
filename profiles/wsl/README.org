...
!Used an older version of nix here, would just rely on the official release instead to setup NixOs on WSL, might fork it here and make some adaptations in the future.
